 ...
 */
	...
	// necesitamos un objeto serializable: coche y concesionario (si lo contiene concesionario es serializable)
	// si el flujo es encapsulamiento de otro hay que usar un Buffer
	// se cierra automáticamente (no hace falta poner el close())
	// dentro del try sólo se puede poner algo autocloseable, por eso no se puede poner "fichero"
	// guardarcomo siempre te va a pedir el nombre del fichero (creas un fichero nuevo y sino lo creas lo machacas)
/**
 * 
 * @param fichero2
 * @return

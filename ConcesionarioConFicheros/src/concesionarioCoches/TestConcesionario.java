...
public class TestConcesionario implements Serializable {
	 ...
	 * usuario
	 * 
	 * @throws FileNotFoundException Exception Excepción cuando no existe un fichero con ese nombre
	 * @throws IOException Excepción cuando se produce un error mientras se lee o escribe
	 */
	 ...
	 * 
	 * @throws FileNotFound Exception Excepción cuando no existe un fichero con ese nombre
	 * @throws IOException Excepción cuando se produce un error mientras se lee o escribe
	 */
	 ...
	 * @throws FileNotFound Exception Excepción cuando no existe un fichero con ese nombre
	 * @throws IOException Excepción cuando se produce un error mientras se lee o escribe
	 * @throws ClassNotFoundException Excepción cuando el objeto encontrado no es el esperado
	 */
